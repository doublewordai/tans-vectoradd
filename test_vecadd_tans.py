...
def main() -> None:
    args = parse_args()
    os.environ["TANS_STREAMS_PER_BLOCK"] = str(args.streams_per_block)
    print("Fused tANS vecadd correctness:\n")
    print(f"mode: spb={args.streams_per_block}")
    for K, N in [
        (1024, 128),
        (10_000, 256),
        (1024, 1024),
